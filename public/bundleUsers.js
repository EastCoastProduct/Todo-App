...
var UserItem = React.createClass({displayName: "UserItem",
    ...
    render: function () {
      ...
      return React.createElement("ul", {className: "task-list"}, 
                  React.createElement("li", {key:  user.id, className: ""}, 
                        React.createElement("span", {className: "task-title"}, 
                            React.createElement("span", {className: "task-title-sp"}, this.state.value), 
                            React.createElement("div", {className: "pull-right"}, 
                                React.createElement("button", {type: "button", className: "btn btn-primary btn-xs"}, 
  ...
  var UsersList = React.createClass({displayName: "UsersList",
    ...
    render: function () {
      ...
      users.forEach(function (user, i) {
        _singleItems.push(React.createElement(UserItem, {key: i, user: users[i]}));
      });
      ...
      return React.createElement("div", {className: "panel-body"}, 
                 ...
                 React.createElement("div", null, 
                 	React.createElement("button", {type: "button", onClick: this.redirectToNewUser, className: "btn btn-success btn-sm pull-left"}, "Add new user")
                 )
             );
    }
  });
...
var usersView = React.createClass({displayName: "usersView",
    render: function() {
        return (
            React.createElement("html", null, 
                React.createElement("head", null, 
                    React.createElement("title", null, "Users List"), 
                    React.createElement("script", {src: "public/bundleUsers.js"}), 
                ...
                React.createElement("body", null, 
                    React.createElement("section", {id: "container"}, 
                        React.createElement("section", {className: "wrapper"}, 
                            React.createElement("h3", null, React.createElement("i", {className: "fa"}), "Users"), 
...
},{"../components/users.js":1,"react":151}]},{},[152]);
