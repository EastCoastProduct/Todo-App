...
var TaskItem = React.createClass({displayName: "TaskItem",
    ...
    render: function () {
      ...
      return React.createElement("ul", {className: "task-list"}, 
                  React.createElement("li", {key:  task.id, className: ""}, 
                        React.createElement("span", {className: "task-title"}, 
                            React.createElement("input", {type: "text", className: "task-title-sp", value: this.state.value, onChange: this.handleChange}), 
                            React.createElement("div", {className: "pull-right"}, 
                                React.createElement("button", {type: "button", onClick: this.edit, className: "btn btn-primary btn-xs"}, 
                                ...
                                React.createElement("button", {type: "button", onClick: this.remove, className: "btn btn-danger btn-xs"}, 
  ...
  var TodoList = React.createClass({displayName: "TodoList",
    ...
    render: function () {
      ...
      tasks.forEach(function (task, i) {
        _singleItems.push(React.createElement(TaskItem, {key: i, task: tasks[i]}));
      });
      ...
      return React.createElement("div", {className: "panel-body"}, 
                 ...
                 React.createElement("form", {onSubmit: this.createTask}, 
                    React.createElement("div", {className: "col-sm-5 nopaddingLeft"}, 
                        React.createElement("input", {type: "text", className: "form-control", onChange:  this.onInput, value:  this.state.name})
                    ), 
...
},{"js-data":5,"js-data-firebase":4,"react":151}],2:[function(require,module,exports){
...
;
},{"firebase":3,"js-data":5}],5:[function(require,module,exports){
/*!
 * js-data
        ...
        return (
            React.createElement("html", null, 
                React.createElement("head", null, 
                    ...
                    React.createElement("script", {src: "public/bundleApp.js"}), 
...
},{"../components/todolist.js":1,"react":151}]},{},[152]);
