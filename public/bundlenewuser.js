...
var NewUser = React.createClass({displayName: "NewUser",
	...
	render: function() {
		return React.createElement("div", null, 
					React.createElement("form", {onSubmit: this.createUser}, 
						React.createElement("div", null, React.createElement("span", {className: "col-md-2"}, "First name:"), 
				           React.createElement("input", {type: "text", value:  this.state.first_name, onChange: this.inputFirstNameTextChange})
				       ), 
				       React.createElement("div", null, React.createElement("span", {className: "col-md-2"}, "Last name:"), 
				           React.createElement("input", {type: "text", value:  this.state.last_name, onChange: this.inputLastNameTextChange})
				       ), 
						React.createElement("div", null, React.createElement("span", {className: "col-md-2"}, "E-mail:"), 
				            React.createElement("input", {type: "text", value:  this.state.email, onChange: this.inputEmailTextChange})
				        ), 
				        React.createElement("div", null, React.createElement("span", {className: "col-md-2"}, "Password:"), 
				            React.createElement("input", {type: "text", value:  this.state.password, onChange: this.inputPasswordTextChange})
				        ), 
	                    React.createElement("div", {className: "col-md-4"}, React.createElement("span", {className: "pull-right"}, React.createElement("button", null, " Add new user ")))
					)
				);
	}
});
...
var newUserView = React.createClass({displayName: "newUserView",
    render: function() {
        return (
            React.createElement("html", null, 
                React.createElement("head", null, 
                    React.createElement("title", null, "To-Do List New User"), 
                    React.createElement("script", {src: "public/bundlenewuser.js"}), 
                ...
                React.createElement("body", null, 
                    React.createElement("section", {id: "container"}, 
                        React.createElement("section", {className: "wrapper"}, 
                            React.createElement("h3", null, React.createElement("i", {className: "fa"}), "Create new user"), 
...
},{"../components/newuser.js":1,"react":149}]},{},[150]);
