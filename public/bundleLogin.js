...
var Login = React.createClass({displayName: "Login",
	...
	render: function() {
		...
		if(this.state.loggedClass) {
			logoutButton = React.createElement(Logout, {onLogout: this.logoutUser});
		} /*else {
			loginButton = <loginButton />;
		}*/

		return React.createElement("div", null, 
				  React.createElement("form", {onSubmit: this.loginUser}, 
                      ...
                      React.createElement("div", {className: "col-md-4"}, React.createElement("span", {className: "pull-right"}, React.createElement("button", null, " Login ")))
				  ), 
				  logoutButton
			   );
	}
...
var Logout = React.createClass({displayName: "Logout",
	...
	render: function() {
		return React.createElement("div", null, 
				React.createElement("form", {onSubmit: this.handleLogout}, 
			   	   React.createElement("div", {className: "col-md-2"}, React.createElement("span", {className: "pull-right"}, React.createElement("button", null, " Logout ")))
			   	)
			   );
	}
});
        ...
        return (
            React.createElement("html", null, 
                React.createElement("head", null, 
                    React.createElement("title", null, "To-Do List Login"), 
                    React.createElement("script", {src: "public/bundleLogin.js"}), 
                ...
                React.createElement("body", null, 
                    React.createElement("section", {id: "container"}, 
                        React.createElement("section", {className: "wrapper"}, 
                            React.createElement("h3", null, React.createElement("i", {className: "fa"}), "Login"), 
...
},{"../components/login.js":1,"react":149}]},{},[150]);
