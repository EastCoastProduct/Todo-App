        ...
        return (
            React.createElement("html", null, 
                React.createElement("head", null, 
                    React.createElement("title", null, "To-Do List"), 
                    React.createElement("script", {src: "public/bundle.js"}), 
                    React.createElement("script", {src: "public/bundlecss.js"})
                ), 
                React.createElement("body", null, 
                    React.createElement("section", {id: "container"}, 
                        React.createElement("section", {className: "wrapper"}, 
                            React.createElement("h3", null, React.createElement("i", {className: "fa"}), "To-Do List"), 
                            React.createElement("div", {className: "row mt"}, 
                                React.createElement("div", {className: "col-md-12"}, 
                                    React.createElement("section", {id: "todoList", className: "task-panel tasks-widget"}, 
...
},{"./components/todolist.js":2,"react":150}],2:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
...
render: function() {
    return React.createElement("div", {className: "panel-body"}, 
                React.createElement("div", {className: "task-content"}, 
                    React.createElement(SingleItem, {items:  this.state.items, onDelete: this.deleteItem, onEdit: this.editItem, onComplete: this.completeItem})
                ), 
                React.createElement("form", {onSubmit: this.addNewItem}, 
                    React.createElement("div", {className: "col-sm-5 nopaddingLeft"}, 
                        React.createElement("input", {type: "text", className: "form-control", onChange:  this.inputTextChange, value:  this.state.text})
                    ), 
                    React.createElement(AddNewTaskButton, null)
                )
            );
    }
});

var SingleItem = React.createClass({displayName: "SingleItem",
...
render: function() {
    return React.createElement("ul", {className: "task-list"}, 
                this.props.items.map(function(item, index){
                    return React.createElement("li", {key: index, className: ""}, 
                                React.createElement("div", {className: "task-checkbox"}, 
                                    React.createElement("input", {type: "checkbox", className: "list-child", value: ""})
                                ), 
                                React.createElement("div", {className: "task-title"}, 
                                    React.createElement("span", {className: "task-title-sp"}, item.text), 
                                    React.createElement("div", {className: "pull-right"}, 
                                        React.createElement("button", {type: "button", onClick: this.handleComplete, className: "btn btn-success btn-xs"}, 
                                            React.createElement("i", {className: "fa"}, " completed ")
                                        ), 
                                        React.createElement("button", {type: "button", onClick: this.handleEdit, className: "btn btn-primary btn-xs"}, 
                                            React.createElement("i", {className: "fa"}, " edit ")
                                        ), 
                                        React.createElement("button", {type: "button", onClick: this.handleDelete, className: "btn btn-danger btn-xs"}, 
                                            React.createElement("i", {className: "fa"}, " delete ")
                                        )
                                    )
                                )
                            )
...
var AddNewTaskButton = React.createClass({displayName: "AddNewTaskButton",
    render: function(){
        return React.createElement("div", {className: "add-task-row"}, 
                    React.createElement("button", {className: "btn btn-success btn-sm pull-left"}, " Add new task ")
                )
    }
});

module.exports = TodoList;
},{"firebase":4,"react":150}],3:[function(require,module,exports){
